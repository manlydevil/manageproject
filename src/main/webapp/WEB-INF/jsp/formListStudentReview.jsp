...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">      
            <form:form modelAttribute="inforSearch" action="${pageContext.servletContext.contextPath}/ListStudentReview/Search" method="POST" id="formListStudent">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <display:table list="${listStudent}" pagesize="20"  sort="list" requestURI="${pageContext.servletContext.contextPath}/ListStudentReview.do" id="student"  class="table table-striped table-bordered table-hover"  >
                            	...
                            	<display:column titleKey="SOURCE" > <c:if test="${not empty student.sourceLink}" > <a href="${student.sourceLink }" >Link </a> </c:if> </display:column>      	            		
                            	<display:column titleKey="DESCRIPTION" > <c:if test="${not empty student.descriptionLink}" > <a href="${student.descriptionLink }">Link</a> </c:if> </display:column>
                            </display:table>                           
                            </div>
